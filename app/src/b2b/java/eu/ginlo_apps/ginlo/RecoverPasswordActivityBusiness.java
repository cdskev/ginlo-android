...
public class RecoverPasswordActivityBusiness extends BaseActivity {
    ...
    protected void onCreateActivity(final Bundle savedInstanceState) {
        ...
        final TextView headerTextView = findViewById(R.id.enter_4x4_header);
        headerTextView.setText(getResources().getString(R.string.recover_password_title));

        final TextView hintView = findViewById(R.id.enter_4x4_hint);
    ...
    public void handleNextClick(final View view) {
        ...
        final String recoveryCode = mText1.getText().toString() + mText2.getText() + mText3.getText() + mText4.getText();

        if (StringUtil.isNullOrEmpty(recoveryCode)) {
            DialogBuilderUtil.buildErrorDialog(RecoverPasswordActivityBusiness.this, getResources().getString(R.string.recover_password_recovery_key_empty)).show();
        } else {
                ...
                try {
                    ...
                    final LoginListener loginListener = new LoginListener() {
                        ...
                        public boolean onLoginComplete(final String password) {
                            ...
                            final Intent intent = new Intent(RecoverPasswordActivityBusiness.this, SetPasswordActivity.class);
    ...
    private void showErrorView() {
        final View errorView = findViewById(R.id.enter_4x4_code_top_warning);
        errorView.setVisibility(View.VISIBLE);
        final TextView errorText = errorView.findViewById(R.id.enter_4x4_code_top_warning_text);
