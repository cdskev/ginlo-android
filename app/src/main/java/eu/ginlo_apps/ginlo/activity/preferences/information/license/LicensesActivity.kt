...
class LicensesActivity : PreferencesBaseActivity() {
    override fun onCreateActivity(savedInstanceState: Bundle?) {
        ...
        recyclerview_third_party_licenses.addItemDecoration(DividerItemDecoration(this, DividerItemDecoration.VERTICAL))
    }
    ...
    private fun getLicenses(): List<LicenseItem> {
        return mutableListOf(
            ...
            LicenseItem(getString(R.string.gson), getString(R.string.license_apache_generic)),
            ...
            LicenseItem(getString(R.string.jitsimeet), getString(R.string.apache_license_2_0)),
            ...
            LicenseItem(getString(R.string.slf4j), getString(R.string.slf4j_license)),
            LicenseItem(getString(R.string.android_logback), getString(R.string.apache_license_2_0)),
            LicenseItem(getString(R.string.kotlinx_coroutines), getString(R.string.kotlinx_coroutines_license)),
            ...
            LicenseItem(getString(R.string.zxing_android_embedded), getString(R.string.zxing_android_embedded_license))
        )
    }
}
