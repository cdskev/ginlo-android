...
import eu.ginlo_apps.ginlo.view.ClickableEmojiconEditTextview.DrawableClickListener.DrawablePosition;

/**
 * @author Florian
 * @version $Revision$, $Date$, $Author$
 */
public class ClickableEmojiconEditTextview
        extends EmojiAppCompatEditText {
    ...
    public ClickableEmojiconEditTextview(Context context) {
        super(context);
    }
    ...
    /**
     * @throws Throwable [!EXC_DESCRIPTION!]
     */
    @Override
