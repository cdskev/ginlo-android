...
public class CompanyContact
    ...
    private void decryptData(final SecretKey key) {
        synchronized (this) {
            try {
                ...
                final String dataString = new String(decryptedData, Encoding.UTF8);
            ...
            } catch (LocalizedException | UnsupportedEncodingException | JsonSyntaxException | JsonIOException e) {
    ...
    public boolean findString(final String name)
        ...
        synchronized (this) {
            ...
            if (mAccountId != null && mAccountId.toLowerCase(Locale.US).contains(searchString)) {
                return true;
            }
            return false;
        }
