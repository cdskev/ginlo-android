...
public class IabException
    ...
    private final eu.ginlo_apps.ginlo.billing.IabResult mResult;

    private IabException(eu.ginlo_apps.ginlo.billing.IabResult r) {
        this(r, null);
    }

    public IabException(int response,
                        String message) {
        this(new eu.ginlo_apps.ginlo.billing.IabResult(response, message));
    }
    ...
    public IabException(int response,
                        String message,
                        Exception cause) {
        this(new eu.ginlo_apps.ginlo.billing.IabResult(response, message), cause);
    }
