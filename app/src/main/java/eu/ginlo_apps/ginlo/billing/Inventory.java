...
public class Inventory {
    ...
    private final Map<String, eu.ginlo_apps.ginlo.billing.Purchase> mPurchaseMap = new HashMap<>();
     ...
     * purchase.
     */
    public eu.ginlo_apps.ginlo.billing.Purchase getPurchase(String sku) {
    ...
    List<String> getAllOwnedSkus(String itemType) {
        ...
        for (eu.ginlo_apps.ginlo.billing.Purchase p : mPurchaseMap.values()) {
     ...
     */
    public List<eu.ginlo_apps.ginlo.billing.Purchase> getAllPurchases() {
