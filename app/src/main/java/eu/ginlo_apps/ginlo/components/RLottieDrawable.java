...
import eu.ginlo_apps.ginlo.util.DispatchQueuePool;
import eu.ginlo_apps.ginlo.util.Utilities;
...
public class RLottieDrawable extends BitmapDrawable implements Animatable {
    ...
    private final static String TAG = "RLottieDrawable";
    ...
    public static String readRes(File path, int rawRes) {
        ...
        try {
            if (path != null) {
                ...
                inputStream = SimsMeApplication.getInstance().getResources().openRawResource(rawRes);
            }
            int readLen;
